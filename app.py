...
COVID_DATA_URL = ('https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports_us/08-04-2020.csv') # Change according to date
@st.cache
def load_covid_data():
